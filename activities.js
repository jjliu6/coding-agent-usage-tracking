...
addAct('high', 'actWater', 'Drink a glass of water', '起身喝杯水');
addAct('high', 'actWindow', 'Look out the window for 20 seconds', '看看窗外 20 秒');
addAct('high', 'actNeckRoll', 'Slow neck rolls, 20 seconds', '慢慢转脖子 20 秒');
addAct('high', 'actShrug', 'Shrug your shoulders 10 times', '耸耸肩 10 次');
addAct('high', 'actWrist', 'Wrist circles 20 seconds', '转转手腕 20 秒');
addAct('high', 'actBlink', 'Blink slowly 15 times', '慢慢眨眼 15 次');
addAct('high', 'actPosture', 'Sit up tall for 30 seconds', '挺直背坐 30 秒');
...
addAct('high', 'actShoulderBack', 'Roll shoulders back 10 times', '向后绕肩 10 圈');
addAct('high', 'actEyesClosed', 'Close your eyes for 20 seconds', '闭眼休息 20 秒');
addAct('high', 'actWiggleToes', 'Wiggle your toes inside your shoes', '在鞋子里动动脚趾');
addAct('high', 'actLoosenMouse', 'Let go of the mouse and uncurl your hand', '松开鼠标，把手指舒展开');
...
addAct('high', 'actHandPump', 'Open and close your hands 15 times', '反复握拳、张开 15 次');
...
addAct('high', 'actTiptoe', 'Stand on tiptoes 10 times', '踮踮脚 10 次');
...
addAct('high', 'actFingerStretch', 'Spread your fingers wide, 10 times', '手指尽量张大 10 次');
...
addAct('mid', 'actDoorStretch', 'Doorway chest stretch 20 seconds', '扶着门框拉伸胸口 20 秒');
...
addAct('mid', 'actToeTouch', 'Touch your toes 8 times', '弯腰摸脚尖 8 次');
addAct('mid', 'actWallSit', 'Wall sit 20 seconds', '靠墙静蹲 20 秒');
addAct('mid', 'actNeckShoulder', 'Neck stretch + shoulder rolls', '拉伸脖子，再转转肩');
addAct('mid', 'actStairsOnce', 'Take the stairs once', '上下一趟楼梯');
addAct('mid', 'actSoftBounce', 'Stand and bounce softly 20 seconds', '站着轻轻颠一颠 20 秒');
addAct('mid', 'actSideLunge', 'Side lunges, 6 each side', '侧弓步，每边 6 次');
addAct('mid', 'actGluteSqueeze', 'Glute squeezes × 15', '夹紧臀部 15 次');
addAct('mid', 'actFarLook', 'Stand and look far away for 1 minute', '站起来眺望远处 1 分钟');
addAct('mid', 'actCarryThing', 'Carry something to another room', '拿点东西送到另一个房间');
addAct('mid', 'actAirSquat', '10 slow air squats', '慢慢做 10 个深蹲');
addAct('mid', 'actOpenWindow', 'Open a window and breathe the air', '打开窗，吸口新鲜空气');
addAct('mid', 'actHipOpener', 'Hip opener, 20s each side', '做开髋动作，每边 20 秒');
...
addAct('low', 'actStepOutside', 'Step outside for 2 minutes', '到外面站 2 分钟');
...
addAct('low', 'actLieDown', 'Lie down, no phone, 2 minutes', '躺 2 分钟，别碰手机');
...
addAct('low', 'actTidyStand', 'Tidy one surface while standing', '站着把一处桌面收拾干净');
addAct('low', 'actPetIfAny', 'Pet an animal if you have one', '有宠物的话去摸两下');
addAct('low', 'actLookSky', 'Look at the sky for 1 minute', '抬头看看天 1 分钟');
addAct('low', 'actHallway3', 'Slow walk down the hallway 3 times', '在走廊里慢慢走 3 个来回');
...
addAct('low', 'actBodyScan', '2-minute body scan, no screen', '做 2 分钟身体扫描，别看屏幕');
...
addAct('low', 'actFloorSit', 'Sit on the floor instead of the chair 2 minutes', '离开椅子，在地上坐 2 分钟');
...
addAct('low', 'actSlowYawnWalk', 'Walk until you yawn once', '走到打出一个哈欠为止');
