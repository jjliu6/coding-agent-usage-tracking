...
addAct('high', 'actWrist', 'Wrist circles 20 seconds', '转手腕 20 秒');
addAct('high', 'actBlink', 'Blink slowly 15 times', '慢慢眨眼 15 次');
addAct('high', 'actPosture', 'Sit up tall for 30 seconds', '坐直 30 秒');
addAct('high', 'actJaw', 'Unclench your jaw, drop your tongue', '松开牙关，舌头放松');
addAct('high', 'actArmShake', 'Drop your arms and shake them out', '放下手臂抖一抖');
addAct('high', 'actAnkle', 'Ankle circles under the desk', '桌下转脚踝');
addAct('high', 'actLookGreen', 'Look at something green for 20 seconds', '看一点绿色 20 秒');
addAct('high', 'actSipWater', 'Sip water — not another coffee', '喝口水，先别续咖啡');
addAct('high', 'actReachUp', 'Stand and reach for the ceiling', '站起来双手向上伸');
addAct('high', 'actEarShoulder', 'Ear-to-shoulder stretch, both sides', '头靠肩拉伸，两边都做');
...
addAct('high', 'actWiggleToes', 'Wiggle your toes inside your shoes', '鞋里活动脚趾');
addAct('high', 'actLoosenMouse', 'Let go of the mouse and uncurl your hand', '松开鼠标，把手摊开');
addAct('high', 'actScreenArm', 'Push the screen to arm’s length', '屏幕推到一臂远');
addAct('high', 'actFiveBreaths', 'Five slow breaths, longer on the exhale', '慢吸 5 次，呼气再长一点');
...
addAct('high', 'actFiveSounds', 'Name 5 sounds you can hear', '数 5 种你听到的声音');
addAct('high', 'actFaceAway', 'Turn your chair away from the screen 30 seconds', '转开椅子背对屏幕 30 秒');
...
addAct('high', 'actDropShoulders', 'Drop your shoulders away from your ears', '肩膀从耳朵上放下来');
...
addAct('mid', 'actForwardFold', 'Forward fold, hang 20 seconds', '体前屈，挂着 20 秒');
...
addAct('mid', 'actArmCircle', 'Arm circles 20 seconds', '抡胳膊 20 秒');
...
addAct('low', 'actSunFace', 'Put sunlight on your face 1 minute', '让脸晒 1 分钟太阳');
...
addAct('low', 'actWarmMug', 'Heat a drink and hold the mug', '热杯喝的，握着杯子歇一会儿');
