...
const I18N = {
  en: {
    ...
    hairLabel: 'HAIR LEFT',
    showHairTip: 'A little person who floats on the dashboard. Hair thins as quota burns; it grows back at reset. Drag it, or let it wander. Under it, pick a stretch / rest when a stage asks.',
    hairTip: 'Hair left this week: {n}% — the more tokens you burn, the balder it gets. Regrows at reset. Drag to move.',
    actHint: 'Pick one — then come back and tap Done.',
    actDoing: 'Doing: {act}',
    actDoingNote: 'Go do it. Come back and tap Done to show the numbers again.',
    actDone: "Done — I'm back",
    actStretch: 'Stand up and stretch 30 seconds',
    actWater: 'Drink a glass of water',
    actWindow: 'Look out the window for 20 seconds',
    actStand: 'Stand and roll your shoulders',
    actSquats: 'Do 10 easy squats',
    actEyes: '20-20-20: look 20 feet away for 20 seconds',
    actWalk: 'Walk to another room and back',
    actGrass: 'Touch some grass / step outside',
    actTea: 'Make tea and rest 2 minutes',
  ...
  zh: {
    ...
    showHair: '发量小人',
    hairLabel: '发量',
    showHairTip: '会在面板上漂着的小人。额度烧得越多头发越少，重置时长回来。可以拖，也会自己晃。下面会按阶段给你 2–3 个活动，选一个去做。',
    hairTip: '本周发量剩 {n}% — token 烧得越多头越秃，额度重置时长回来。按住可以拖走。',
    actHint: '选一件去做，做完回来点「完成」。',
    actDoing: '正在：{act}',
    actDoingNote: '先去做。回来点「完成」，数字界面就会回来。',
    actDone: '完成，我回来了',
    actStretch: '站起来伸个懒腰 30 秒',
    actWater: '喝一杯水',
    actWindow: '看窗外 20 秒',
    actStand: '站起来转转肩膀',
    actSquats: '做 10 个轻松深蹲',
    actEyes: '20-20-20：看 6 米外 20 秒',
    actWalk: '走到另一个房间再回来',
    actGrass: '出门踩两脚草 / 透个气',
    actTea: '泡杯茶休息 2 分钟',
    moveReminder: '动一动提醒',
