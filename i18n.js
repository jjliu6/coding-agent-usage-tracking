...
const I18N = {
  en: {
    ...
    showHairTip: 'A little head in the header whose hair thins as your quota burns — it grows back at reset.',
    hairTip: 'Hair left this week: {n}% — the more tokens you burn, the balder it gets. Regrows at reset.',
  ...
  zh: {
    ...
    spark7d: '近 7 天剩余额度走势',
    showHair: '发量小人',
    showHairTip: '标题栏里的小脑袋：额度烧得越多头发越少，额度重置时长回来。',
    hairTip: '本周发量剩 {n}% — token 烧得越多头越秃，额度重置时长回来。',
    moveReminder: '动一动提醒',
